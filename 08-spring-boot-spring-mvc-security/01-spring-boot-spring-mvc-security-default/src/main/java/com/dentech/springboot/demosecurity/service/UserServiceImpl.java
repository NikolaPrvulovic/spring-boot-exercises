...
import com.dentech.springboot.demosecurity.dao.RoleDao;
import com.dentech.springboot.demosecurity.dao.UserDao;
...
public class UserServiceImpl implements UserService {
	...
	public void save(WebUser webUser) {
		...
		// give user default role of "prosthetist"
		user.setRoles(Arrays.asList(roleDao.findRoleByName("ROLE_PROSTHETIST")));
